...
import { LATEST_VERSION } from "@/lib/constants.mjs";
    ...
    return (
        <header
            ...
            className={cn(
                ...
                "sticky top-(--fd-docs-row-1) z-10 flex h-[58px] items-center gap-3 border-b px-5 backdrop-blur-[12px] [grid-area:header] layout:[--fd-header-height:58px]",
        ...
        >
            <div className="flex flex-none items-center gap-2.5">
                ...
                <span className="font-mono text-base text-fd-border max-sm:hidden">/</span>
                <Link
                    href={getDocsUrl([LATEST_VERSION], locale)}
                    className="font-mono text-[15px] font-medium text-fd-muted-foreground transition-colors hover:text-fd-foreground max-sm:hidden"
                >
                    docs
                </Link>
            </div>
