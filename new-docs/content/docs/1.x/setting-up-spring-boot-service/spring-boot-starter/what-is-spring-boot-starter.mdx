---
title: What is the Axelix Spring Boot Starter?
description: "The Axelix Spring Boot Starter is the bridge between your Spring Boot applications and the Axelix Master management console."
---

Axelix Starter (also known as ASBS - Axelix Spring Boot Starter) is a Spring Boot starter dependency that enables your
Spring Boot applications to integrate seamlessly with the Axelix platform. It's the bridge between your applications and
the Axelix Master management console.

## Overview

Axelix Starter transforms your standard Spring Boot application into a "managed service" that can be monitored,
debugged, and controlled through the Axelix Master interface. It works by extending Spring Boot's native capabilities
and providing additional endpoints and functionality.
