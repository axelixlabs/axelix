...
This documentation covers both **Axelix OSS**, released under LGPL 3.0 with sources at [github.com/axelixlabs/axelix](https://github.com/axelixlabs/axelix), and the upcoming paid **Axelix Enterprise** edition with additional features (in development — stay tuned for news).
