...
A Spring Boot starter that is included in Spring Boot applications to enable Axile integration. It provides the
necessary capabilities that are called by the Axile Master.
