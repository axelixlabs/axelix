...
How the OAuth2 / OIDC sign-in flow works end-to-end is covered on the [Authentication](../authentication/authentication.mdx#oauth2--oidc) page.
...
- [What is Master?](../what-is-master.md) — background on what Master does once it is running.
