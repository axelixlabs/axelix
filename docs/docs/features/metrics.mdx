...
![metrics main page](../../static/img/feature/metrics/metrics-main-page.png) ***Metrics as presented in Axelix UI***
...
- `axelix_transaction_duration` — `Timer` tagged by `class`, `method`, and `status=success|error`.
...
![metric details page](../../static/img/feature/metrics/metrics-details-page.png) ***JVM Memory Metric details as
...
- **Description**: Hover your cursor over the icon ![metric details
  page](../../static/img/feature/icons/question-icon.png) to see what this metric measures.
