...
You can find more details about each metric [on the corresponding page](../installation/configuring-spring-boot-starter#export-axelix-metrics-through-micrometer).
