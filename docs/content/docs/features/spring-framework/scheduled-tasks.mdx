...
description: "The Scheduled Tasks page provides access to all tasks annotated with @Scheduled within a Spring Boot application.
              You can also update the task status, modify its schedule, and trigger it manually when required."
---

![scheduled tasks main page](/img/feature/scheduled-tasks/scheduled-tasks-main-page.png) ***Scheduled Tasks
...
### Cron
![cron expression page details](/img/feature/scheduled-tasks/cron-expression-page-details.png) ***Scheduled
...
- **Status**:                   Shows the target state and provides the ability to enable <Image
  src="/img/feature/icons/switch-on-icon.png" alt="switch-on-icon" width={35} height={18}/> or disable <Image
  src="/img/feature/icons/switch-off-icon.png" alt="switch-off-icon" width={35} height={18}/> the target. (See
  **Interactive Features**)
- **Run**:                      Forces immediate execution of the task. (See **Interactive Features**)

### Fixed delay
![fixed delay page details](/img/feature/scheduled-tasks/fixed-delay-page-details.png) ***Scheduled Tasks as
...
### Fixed rate
![fixed rate page details](/img/feature/scheduled-tasks/fixed-rate-page-details.png) ***Scheduled Tasks as
presented in Axelix UI***
...
### Run
We provide the ability to trigger a task manually without affecting its schedule. To do so, simply click <Image
...
1. Click <Image src="/img/feature/icons/overwrite-icon.png" alt="overwrite-icon" width={20} height={20}/> next to the
...
2. An interactive dialog will open, allowing you to make changes. When you edit a cron expression, the dialog shows a
   ...
   <Image src="/img/feature/icons/cancel-icon.png" alt="cancel-icon" width={20} height={20}/> to cancel the change, or the
   <Image src="/img/feature/icons/save-icon.png" alt="save-icon" width={20} height={20}/> to confirm the action.
3. Once confirmed, the task will follow the new schedule.

### Status
We provide the ability to manage the target state. The initial state of each target is (on) <Image
src="/img/feature/icons/switch-on-icon.png" alt="switch-on-icon" width={35} height={18}/>, meaning the task is executed
according to the configured schedule. When the **Status** is switched to (off) <Image
src="/img/feature/icons/switch-off-icon.png" alt="switch-off-icon" width={35} height={18}/>, a target that is currently
...
<Image src="/img/feature/icons/switch-on-icon.png" alt="switch-on-icon" width={35} height={18}/>.
