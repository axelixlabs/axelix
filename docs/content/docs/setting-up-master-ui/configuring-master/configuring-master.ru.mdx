---
title: Настройка Master
description: "На этой странице показано, как запустить Axelix Master в вашей среде. Выберите формат, который соответствует тому, как
...
[Аутентификация](../authentication/authentication.ru.mdx#oauth2--oidc).
...
- [Настройка Spring Boot
  Starter](../../setting-up-spring-boot-service/spring-boot-starter/configuration.ru.mdx) — подключите
  ваши мониторируемые сервисы, чтобы Master их увидел.
- [Что такое Master?](../what-is-master.ru.mdx) — фон того, что делает Master, когда он запущен.
- [Аутентификация](../authentication/authentication.ru.mdx) — углублённый взгляд на JWT, суперадминистратора и OAuth2/OIDC.
