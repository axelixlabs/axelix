...
|------------------------------|--------------|----------------------------------------------------------------------------------------------------|
| `axelix.master.environment` | пусто        | Имя среды, в которой работает этот экземпляр Master, например `production` или `staging`.        |
...
По умолчанию Master выводит в консоль обычный текст. Установите `axelix.master.logging.json=true`, чтобы переключиться
на структурированное JSON-логирование в формате [Elastic Common Schema](https://www.elastic.co/guide/en/ecs/8.11/ecs-reference.html)
...
| Свойство                     | По умолчанию | Описание                                                                       |
|-------------------------------|--------------|-------------------------------------------------------------------------------------|
| `axelix.master.logging.json` | `false`      | Переключить логирование в консоль с обычного текста на структурированный JSON ECS. |
