...
import { SUPPORT_STATUS_ORDER, supportSignalClassToken, supportSignalLabelKey } from "@/utils";
                ...
                {SUPPORT_STATUS_ORDER.map((status) => {
                    ...
                    return (
                        <button
                            ...
                            className={`${styles.Chip} ${styles[supportSignalClassToken[status]]} ${active ? styles.ActiveChip : ""}`}
                        >
