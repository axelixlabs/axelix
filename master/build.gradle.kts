...
openApiGenerate {
    ...
    modelPackage.set("com.axelixlabs.axelix.master.contract.scheduledtask")
...
sourceSets {
    main {
        java {
            // builtBy carries the task dependency to every consumer of the source set, so no
            // compile task needs an explicit dependsOn.
