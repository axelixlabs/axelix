...
class SpaStaticResourcesIntegrationTest {
    ...
    void servesExistingAsset() throws Exception {
        String expected = StreamUtils.copyToString(
                new ClassPathResource(SPA_DIST + "/assets/main.js").getInputStream(), UTF_8);
    ...
    void servesExistingCss() throws Exception {
        String expected = StreamUtils.copyToString(
                new ClassPathResource(SPA_DIST + "/assets/style.css").getInputStream(), UTF_8);
    ...
    void shouldServesIndexHtml(String contextPath) throws Exception {
        String expected = StreamUtils.copyToString(
                new ClassPathResource(SPA_DIST + "/index.html").getInputStream(), UTF_8);
