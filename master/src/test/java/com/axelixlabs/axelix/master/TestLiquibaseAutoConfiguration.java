...
/**
 * Points Liquibase at :master's own changelog for :master's own tests.
 *
 * @author Nikita Kirillov
 */
@Configuration
public class TestLiquibaseAutoConfiguration {

    @Configuration
    @ConditionalOnCommunityRdbms(CommunityRDBMS.SQLITE)
    static class SQLiteTestLiquibaseConfiguration {

        @Bean
        @Primary
        LiquibaseProperties sqliteLiquibaseProperties() {
    ...
    static class PostgresTestLiquibaseConfiguration {

        @Bean
        @Primary
        LiquibaseProperties postgresLiquibaseProperties() {
            LiquibaseProperties liquibaseProperties = new LiquibaseProperties();
    ...
    static class MySqlTestLiquibaseConfiguration {

        @Bean
        @Primary
        LiquibaseProperties mysqlLiquibaseProperties() {
            LiquibaseProperties liquibaseProperties = new LiquibaseProperties();
