...
/**
 * {@link AbstractEndpointProber} that specifically works with {@link ActuatorEndpoints#ENABLE_CACHE /caches} endpoint.
 *
 * @since 26.11.2025
 * @author Nikita Kirillov
 */
@Service
public class EnableCacheEndpointProber extends DiscardingAbstractEndpointProber {

    public EnableCacheEndpointProber(InstanceRegistry instanceRegistry) {
        super(instanceRegistry);
    }

    @Override
    public @NonNull ActuatorEndpoint supports() {
        return ActuatorEndpoints.ENABLE_CACHE;
    }
}
