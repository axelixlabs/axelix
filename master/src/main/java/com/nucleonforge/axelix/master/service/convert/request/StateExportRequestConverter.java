 ...
 */
package com.nucleonforge.axelix.master.service.convert.request;

import org.jspecify.annotations.NonNull;

import org.springframework.stereotype.Component;

import com.nucleonforge.axelix.master.api.request.state.StateComponentSettings;
import com.nucleonforge.axelix.master.api.request.state.StateExportRequest;
import com.nucleonforge.axelix.master.service.convert.response.Converter;
import com.nucleonforge.axelix.master.service.export.StateExport;
import com.nucleonforge.axelix.master.service.export.settings.BeansStateComponentSettings;
import com.nucleonforge.axelix.master.service.export.settings.CachesStateComponentSettings;
...
import com.nucleonforge.axelix.master.service.export.settings.ThreadDumpStateComponentSettings;
...
public class StateExportRequestConverter implements Converter<StateExportRequest, StateExport> {
    ...
    private com.nucleonforge.axelix.master.service.export.StateComponentSettings map(StateComponentSettings it) {
        return switch (it.getComponent()) {
            case HEAP_DUMP ->
                new HeapDumpStateComponentSettings(
                        ((com.nucleonforge.axelix.master.api.request.state.HeapDumpStateComponentSettings) it)
                                .sanitized());
