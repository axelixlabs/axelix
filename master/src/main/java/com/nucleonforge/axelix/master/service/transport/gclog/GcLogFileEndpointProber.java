 ...
 */
@Service
public class GcLogFileEndpointProber extends AbstractEndpointProber<Resource> {

    public GcLogFileEndpointProber(
            InstanceRegistry instanceRegistry, GcLogFileMessageDeserializationStrategy messageDeserializationStrategy) {
        super(instanceRegistry, messageDeserializationStrategy);
    }

    @Override
    public @NonNull ActuatorEndpoint supports() {
        return ActuatorEndpoints.GC_LOG_FILE;
    }
}
