 ...
 * {@link ActuatorEndpoints#THREAD_DUMP_ENABLE_CONTENTION_MONITORING} endpoint.
 *
 * @author Sergey Cherkasov
 */
@Service
public class ThreadDumpEnableContentionMonitoringProber extends DiscardingAbstractEndpointProber {
    public ThreadDumpEnableContentionMonitoringProber(InstanceRegistry instanceRegistry) {
        super(instanceRegistry);
    }

    @Override
    public @NonNull ActuatorEndpoint supports() {
        return ActuatorEndpoints.THREAD_DUMP_ENABLE_CONTENTION_MONITORING;
    }
}
