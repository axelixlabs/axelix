...
import com.nucleonforge.axile.common.auth.rbac.core.JwtRole;
 ...
 */
public class RbacJwtEncoderService implements JwtEncoderService {
    ...
    public RbacJwtEncoderService(final JwtAlgorithm algorithm, final String signingKey, final Duration lifespan) {
