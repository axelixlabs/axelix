 ...
 * inside the given {@link InstanceReference} about the given {@link SoftwareComponent}.
 *
...
public interface SoftwareDistributionDiscoverer<T extends SoftwareComponent> {
    ...
    @Nullable
    SoftwareDistribution discover(@NonNull BuildInfo buildInfo); // TODO check doc
}
