 ...
 *
 * @param <I> the type of the request body (input).
 * @param <O> the type of the response body (output).
 * @author Mikhail Polivakha
 */
public interface EndpointProber<I, O> {

    /**
     * Invoke the actual {@link ActuatorEndpoint} on the managed service.
     *
     * @param body the request body to be sent to the managed service.
     ...
     */
    @NonNull
    O invoke(@Nullable I body, InstanceId instanceId) throws EndpointInvocationException, InstanceNotFoundException;
