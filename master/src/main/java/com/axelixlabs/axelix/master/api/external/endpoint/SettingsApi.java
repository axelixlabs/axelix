...
public class SettingsApi {
    ...
    private final LicensingInfoResolver licensingInfoResolver;
    ...
    public SettingsApi(
            ...
            LicensingInfoResolver licensingInfoResolver) {
        this.isMcpServerEnabled = isMcpServerEnabled;
        this.authSettings = authSettings;
        this.licensingInfoResolver = licensingInfoResolver;
    }
    ...
    public AxelixSettings getAxelixSettings() {
        ...
        return new AxelixSettings(authenticationOptions, isMcpServerEnabled, licensingInfoResolver.resolve());
    }
}
