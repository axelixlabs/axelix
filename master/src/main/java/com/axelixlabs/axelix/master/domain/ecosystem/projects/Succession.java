...
/**
 * Where a team should look once a {@link SoftwareProject} is no longer {@link SupportStatus#ACTIVE}.
 * <p>
 * The {@link #value()} is an arbitrary description rather than {@link Library} on purpose. A successor is not always another
 * Maven artifact - it can be the JDK itself ({@code java.time}), a whole version line under different libraries
