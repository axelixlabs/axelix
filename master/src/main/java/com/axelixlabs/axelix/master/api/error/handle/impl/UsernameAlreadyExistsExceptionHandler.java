...
/**
 * The exception handler for the {@link UsernameAlreadyExistsException}.
 *
...
public class UsernameAlreadyExistsExceptionHandler implements ExceptionHandler<UsernameAlreadyExistsException> {
    ...
    @Override
    public Class<UsernameAlreadyExistsException> supported() {
        return UsernameAlreadyExistsException.class;
    }
}
