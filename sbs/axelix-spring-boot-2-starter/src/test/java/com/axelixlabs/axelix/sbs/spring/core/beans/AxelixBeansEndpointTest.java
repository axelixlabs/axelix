 ...
 */
class AxelixBeansEndpointTest extends AbstractEndpointIntegrationTest {
    ...
    private static void assertQualifiersPostProcessorBean(BeansFeed beanNameToBeanFeed) {
        BeansFeed.Bean bean =
                getBean(beanNameToBeanFeed, BeansEndpointTestConfiguration.QUALIFIERS_PERSISTENCE_POST_PROCESSOR);
        ...
        assertThat(bean.getBeanSource())
                ...
                .satisfies(beanMethod -> {
                    assertThat(beanMethod.getMethodName())
                            .isEqualTo(BeansEndpointTestConfiguration.QUALIFIERS_PERSISTENCE_POST_PROCESSOR);
                    assertThat(beanMethod.getEnclosingClassName())
                            .isEqualTo(BeansEndpointTestConfiguration.class.getSimpleName());
                });
    ...
    private static void assertBeanMetaInfoExtractor(BeansFeed beanNameToBeanFeed) {
        BeansFeed.Bean bean = getBean(beanNameToBeanFeed, BeansEndpointTestConfiguration.BEAN_META_INFO_EXTRACTOR);
        ...
        assertThat(bean.getBeanSource())
                ...
                .satisfies(beanMethod -> {
                    assertThat(beanMethod.getMethodName())
                            .isEqualTo(BeansEndpointTestConfiguration.BEAN_META_INFO_EXTRACTOR);
                    assertThat(beanMethod.getEnclosingClassName())
                            .isEqualTo(BeansEndpointTestConfiguration.class.getSimpleName());
                });
        assertThat(bean.isConfigPropsBean()).isFalse();
    ...
    private static void assertCustomBeanSupplier(BeansFeed beanNameToBeanFeed) {
        BeansFeed.Bean bean = getBean(beanNameToBeanFeed, BeansEndpointTestConfiguration.CUSTOM_SUPPLIER);

        assertThat(bean.getBeanSource()).isInstanceOf(BeansFeed.BeanMethod.class);
        assertThat(bean.getBeanSource())
                .asInstanceOf(type(BeansFeed.BeanMethod.class))
                .satisfies(beanMethod -> {
                    assertThat(beanMethod.getMethodName()).isEqualTo(BeansEndpointTestConfiguration.CUSTOM_SUPPLIER);
                    assertThat(beanMethod.getEnclosingClassName())
                            .isEqualTo(BeansEndpointTestConfiguration.class.getSimpleName());
                });
        assertThat(bean.isConfigPropsBean()).isFalse();
    ...
    private static void assertConfigPropsBeanName(BeansFeed beanNameToBeanFeed) {
        BeansFeed.Bean bean = getBean(beanNameToBeanFeed, AxelixTestProperties.class.getName());

        assertThat(bean.getClassName()).isEqualTo(AxelixTestProperties.class.getName());
