...
class ScheduledTasksRegistryTest {
    ...
    private static final String CRON_TASK_ID =
            "com.nucleonforge.axile.spring.scheduled.ScheduledTasksRegistryTest$ScheduledTaskRegistryTestConfiguration.testCronTask";
    private static final String FIXED_DELAY_TASK_ID =
            "com.nucleonforge.axile.spring.scheduled.ScheduledTasksRegistryTest$ScheduledTaskRegistryTestConfiguration.testFixedDelayTask";
    private static final String FIXED_RATE_TASK_ID =
            "com.nucleonforge.axile.spring.scheduled.ScheduledTasksRegistryTest$ScheduledTaskRegistryTestConfiguration.testFixedRateTask";
    private static final String CUSTOM_TASK_ID =
            "com.nucleonforge.axile.spring.scheduled.ScheduledTaskRegistryTest$ScheduledTaskRegistryTestConfiguration.testCustomTask";
