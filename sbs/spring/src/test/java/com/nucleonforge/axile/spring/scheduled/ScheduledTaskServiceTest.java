...
class ScheduledTaskServiceTest {
    ...
    private static final String CRON_TASK_ID =
            "com.nucleonforge.axile.spring.scheduled.ScheduledTaskServiceTest$ScheduledTaskServiceTestConfiguration.testCronTask";
    private static final String FIXED_DELAY_TASK_ID =
            "com.nucleonforge.axile.spring.scheduled.ScheduledTaskServiceTest$ScheduledTaskServiceTestConfiguration.testFixedDelayTask";
    private static final String FIXED_RATE_TASK_ID =
            "com.nucleonforge.axile.spring.scheduled.ScheduledTaskServiceTest$ScheduledTaskServiceTestConfiguration.testFixedRateTask";
    private static final String CUSTOM_TASK_ID =
            "com.nucleonforge.axile.spring.scheduled.ScheduledTaskServiceTest$ScheduledTaskServiceTestConfiguration.testCustomTask";
