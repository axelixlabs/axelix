        ...
        "cron": [
         {
             "delegate": {
                  "runnable": {
                     "target": "com.nucleonforge.axile.spring.scheduled.ScheduledTasksEndpointExtensionTest$ScheduledTasksEndpointExtensionTestConfiguration.testCronTask"
                 },
                  "expression": "*/1 * * * * *"
              },
              "enabled": true
       ...
       "fixedDelay": [
          {
              "delegate": {
                  "runnable": {
                      "target": "com.nucleonforge.axile.spring.scheduled.ScheduledTasksEndpointExtensionTest$ScheduledTasksEndpointExtensionTestConfiguration.testFixedDelayTask"
                  },
                  "initialDelay": 0,
                  "interval": 1000
              },
        ...
        "fixedRate": [
          {
              "delegate": {
                  "runnable": {
                      "target": "com.nucleonforge.axile.spring.scheduled.ScheduledTasksEndpointExtensionTest$ScheduledTasksEndpointExtensionTestConfiguration.testFixedRateTask"
                  },
                 "initialDelay": 100,
                  "interval": 1000
              },
        ...
        "custom": [
          {
              "delegate": {
                  "runnable": {
                      "target": "com.nucleonforge.axile.spring.scheduled.ScheduledTasksEndpointExtensionTest$ScheduledTasksEndpointExtensionTestConfiguration$CustomTestTask"
                  },
    ...
    static class ScheduledTasksEndpointExtensionTestConfiguration implements SchedulingConfigurer {
        ...
        static class CustomTestTask implements Runnable {
            ...
            public String toString() {
                return "com.nucleonforge.axile.spring.scheduled.ScheduledTasksEndpointExtensionTest$ScheduledTasksEndpointExtensionTestConfiguration$CustomTestTask";
            }
        }
