...
class TransactionAccessor {
    ...
    void recordNewTransactionStarted() {
     ...
     */
    void recordSqlQuery(SimpleSqlQueryRecord sqlQueryRecord) {
     ...
     */
    void recordLazyLoading(LazyLoadingTarget lazyLoadingTarget) throws IllegalStateException {
        TransactionExecutionProfile currentTransactionProfile = getCurrentTransactionProfile();
    ...
    TransactionExecutionProfile recordTransactionCompletion() {
