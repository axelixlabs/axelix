...
class ProxyingDataSource implements DataSource {
    ...
    public Connection getConnection() throws SQLException {
        return new ProxyingConnection(delegate.getConnection(), transactionAccessor);
    }

    @Override
    public Connection getConnection(String username, String password) throws SQLException {
        return new ProxyingConnection(delegate.getConnection(username, password), transactionAccessor);
    }
