...
public class ProxyingPreparedStatement implements PreparedStatement {
    ...
    private <T> T wrapExecute(SqlAction<T> action) throws SQLException {
        ...
        try {
            ...
            transactionAccessor.recordSqlQuery(
                    new SimpleSqlQueryRecord(sql, durationNs / 1_000_000, startTimestampMs, inMemoryPaginated));
        }
    }
    ...
    public ResultSet executeQuery() throws SQLException {
        return wrapExecute(delegate::executeQuery);
    }

    @Override
    public int executeUpdate() throws SQLException {
        return wrapExecute(delegate::executeUpdate);
    }

    @Override
    public boolean execute() throws SQLException {
        return wrapExecute(delegate::execute);
    }

    @Override
    public long executeLargeUpdate() throws SQLException {
        return wrapExecute(delegate::executeLargeUpdate);
    }

    @Override
    public int[] executeBatch() throws SQLException {
        return wrapExecute(delegate::executeBatch);
    }
