...
class NPlusOneAnalyzerTest {
    ...
    class CollectionLoads {
        ...
        void shouldMarkAsBatchPlusOne_whenMultipleBatchCollectionLoads() {
            // given
            NPlusOneContext context = new NPlusOneContext();
            context.getCollectionLoadsSnapshot().record("com.example.Order.items", 1, 1, true);
            context.getCollectionLoadsSnapshot().record("com.example.Order.items", 2, 2, true);
        ...
        void shouldHandleMultipleRoles_independently() {
            ...
            NPlusOneContext context = new NPlusOneContext();
            // N+1 on first role
            context.getCollectionLoadsSnapshot().record("com.example.Order.items", 1, 1, false);
            context.getCollectionLoadsSnapshot().record("com.example.Order.items", 2, 2, false);
            // only one load, not N+1
            context.getCollectionLoadsSnapshot().record("com.example.Order.tags", 1, 3, false);
    ...
    class EntityLoads {
        ...
        void shouldNotMarkQuery_whenSingleEntityLoad() {
            // given
            NPlusOneContext context = new NPlusOneContext();
            context.getEntityLoadsSnapshot().record("com.example.Item", 1, 1, false);
        ...
        void shouldMarkQueries_whenMultipleEntityLoads() {
            ...
            NPlusOneContext context = new NPlusOneContext();
            context.getEntityLoadsSnapshot().record("com.example.Item", 1, 1, false);
            context.getEntityLoadsSnapshot().record("com.example.Item", 2, 2, false);
            context.getEntityLoadsSnapshot().record("com.example.Item", 3, 3, false);
        ...
        void shouldMarkAsBatchPlusOne_whenMultipleBatchEntityLoads() {
            // given
            NPlusOneContext context = new NPlusOneContext();
            context.getEntityLoadsSnapshot().record("com.example.Item", 1, 1, true);
            context.getEntityLoadsSnapshot().record("com.example.Item", 2, 2, true);
