...
/**
 * The annotation must be applied to the test class to document why the test does not share a common
 * {@code TestContext} with its siblings (for example because it mutates the application context).
 *
