        ...
        actuatorResponse.getContexts().forEach((contextId, contextDescriptor) -> {
            ...
            if (targetContext != null) {
                ...
                contextDescriptor.getBeans().forEach((beanName, beanDescriptor) -> {
                    ...
                    Class<?> clazz = Objects.requireNonNull(beanDescriptor.getType());
                    String beanType =
                            BeanNameUtils.resolveBeanTypeName(clazz, metaInfo.getBeanSource(), clazz.isHidden());
                    ...
                    beans.add(new Bean()
                            ...
                            .className(beanType)
                            .scope(StringUtils.emptyIfNull(beanDescriptor.getScope()))
    ...
    private List<BeanDependency> resolveDependencies(
        ...
        return Arrays.stream(dependencies)
                ...
                .filter(dep -> {
                    ...
                    if (beanSource instanceof BeanMethod beanMethod) {
                        try {
