...
class DefaultScheduledTasksAssemblerTest {
     ...
     * and the class is final in Spring Boot 2.
     */
    ...
    class TaskTypes {
        ...
        void shouldAssembleAllTaskTypes() {
            ...
            FixedRateTask fixedRateTask = new FixedRateTask(fixedRateRunnable, 2000L, 100L);
            FixedDelayTask fixedDelayTask = new FixedDelayTask(fixedDelayRunnable, 3000L, 200L);
