...
/**
 * Bean declarations that drive {@link QualifiersPersistencePostProcessorTest}. Imported into the
 * shared endpoint test context so the {@code BeanFactoryPostProcessor} populates
 * {@link DefaultQualifiersRegistry#INSTANCE} with the test-specific bean names.
 *
 * @author Mikhail Polivakha
 */
@TestConfiguration
@Import({
    QualifiersPersistenceTestFixtures.BeanMethodDeclarations.class,
    QualifiersPersistenceTestFixtures.ComponentMethodDeclarations.class,
    QualifiersPersistenceTestFixtures.ConfigurationClassesDeclarations.class
})
public class QualifiersPersistenceTestFixtures {
