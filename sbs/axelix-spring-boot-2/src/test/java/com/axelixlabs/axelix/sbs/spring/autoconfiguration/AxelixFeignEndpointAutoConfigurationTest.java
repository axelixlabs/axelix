...
class AxelixFeignEndpointAutoConfigurationTest {
    ...
    static class CustomFeignClientIntegrationDiscovererConfig {
        @Bean
        public FeignClientIntegrationDiscoverer customFeignClientIntegrationDiscoverer(
                ApplicationContext context, Environment environment) {
            return new CustomFeignClientIntegrationDiscoverer(context, new NoOpTestDiscoveryClient(), environment);
        }
    }
