 ...
 */
class NPlusOneIntegrator implements Integrator {

    private final NPlusOneEntityLoadListener loadListener;
    private final NPlusOneCollectionLoadListener collectionListener;

    NPlusOneIntegrator(NPlusOneEntityLoadListener loadListener, NPlusOneCollectionLoadListener collectionListener) {
