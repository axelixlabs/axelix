 ...
 */
class NPlusOneCollectionLoadListener implements InitializeCollectionEventListener {

    private static final Logger log = LoggerFactory.getLogger(NPlusOneCollectionLoadListener.class);

    private final TransactionAccessor transactionAccessor;

    NPlusOneCollectionLoadListener(TransactionAccessor transactionAccessor) {
