 ...
 * <p>
 *
 * @see NPlusOneHolder#recordEntityLoad(String, Object, boolean)
 * @author Nikita Kirillov
 */
public class NPlusOneEntityLoadListener implements LoadEventListener {

    private final NPlusOneHolder nPlusOneHolder;

    public NPlusOneEntityLoadListener(NPlusOneHolder nPlusOneHolder) {
    ...
    public void onLoad(LoadEvent event, LoadType loadType) {
        ...
        nPlusOneHolder.recordEntityLoad(entityClassName, id, isBatch);
    }
}
