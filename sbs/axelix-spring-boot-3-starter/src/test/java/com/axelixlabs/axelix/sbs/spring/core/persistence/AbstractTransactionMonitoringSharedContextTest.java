...
public abstract class AbstractTransactionMonitoringSharedContextTest {
    ...
    static class SharedTransactionTestConfiguration {
        ...
        public NPlusOneTestHelper nPlusOneTestHelper(
                N1OrderRepository orderRepository, N1ItemRepository itemRepository) {
            return new NPlusOneTestHelper(orderRepository, itemRepository);
        }
    }
    ...
    public static class NPlusOneTestHelper {
        ...
        NPlusOneTestHelper(N1OrderRepository orderRepository, N1ItemRepository itemRepository) {
