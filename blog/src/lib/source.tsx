 ...
 */
import { IBlogCardItem, TBlogPage } from "@/models";
...
export function getCardImageSrc(page: TBlogPage): string | null {
...
export function getSortedPosts(): TBlogPage[] {
    return [...blog.getPages()].sort((a, b) => b.data.date.getTime() - a.data.date.getTime());
}

export async function toCardItem(page: TBlogPage): Promise<IBlogCardItem> {
