import {
    ...
    MockImageImage,
    PropertiesFeedImage,
    SchedukedTaskFeedImage,
    TransactionsFeedImage,
} from "@/assets";
import { ELanguage, IInstallationInstructions, IWhatCanDoCardData, IZigzagSectionData } from "@/models";
...
export const whatCanDoCardsData: IWhatCanDoCardData[] = [
    {
        ...
        description:
            "Gain deep insights into Application Context beans, including their origins and details on why certain beans were excluded.",
        category: "@Bean",
    ...
    },
    {
        ...
        description:
            "Gain visibility into <code>@Transactional</code> execution timelines and identify potential performance pitfalls before they escalate",
    ...
    },
    {
        ...
        description:
            "Trace Spring Boot property values to their origins and identify which configuration source or override is currently in effect",
        category: "@Value",
    ...
    },
    {
        ...
        description:
            "Take command of background jobs by toggling tasks, redefining cron expressions, and triggering manual executions with a click",
        category: "@Scheduled",
    ...
    },
    {
        ...
        description:
            "Manage your data layer by monitoring real-time cache efficiency and hit/miss ratios while clearing or toggling caches instantly",
        category: "@Cacheable",
    ...
    },
    {
        ...
        description:
            "Analyze the results of <code>@Conditional</code> evaluations and explore the specific reasons behind each outcome",
...
export const zigzagSectionsData: IZigzagSectionData[] = [
    {
        ...
        description:
            "Axelix is a product that is natively designed to be used by both humans and AI models. " +
...
export const installationOptions: IInstallationInstructions[] = [
    {
        option: "Docker",
        description:
            "The docker installation involves pulling an image, running it, and then launching your Spring Boot microservices with configured Axelix Spring Boot starter",
        steps: [
            {
    ...
    },
    {
        ...
        description:
            "The docker compose installation involves adding and configuring Axelix Spring Boot starter, and then launching your microservices along with Axelix UI via docker compose",
        steps: [
            addStarterStep(),
            configureStarterStep(),
            {
    ...
    },
    {
        option: "Kubernetes",
        description:
            "The K8S installation involves pulling and then installing a helm chart into the K8S cluster, and then adding Axelix Spring Boot starter to your microservices and configuring it",
        steps: [
            {
                name: "Pull Chart",
                codeSampleGroups: [
