 ...
 */
public class BasicJwtVerificationStrategyFactory {

    private BasicJwtVerificationStrategyFactory() {}

    public static BasicJwtVerificationStrategy createVerificationStrategy(JwtAlgorithm algorithm) {
        return switch (algorithm) {
            case HMAC256, HMAC384, HMAC512 -> new BasicHmacVerificationStrategy();
        };
    }
}
