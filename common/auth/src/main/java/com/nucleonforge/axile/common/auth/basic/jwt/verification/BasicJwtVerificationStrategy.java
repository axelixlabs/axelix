 ...
 * verifying their digital signatures.</p>
 *
 * @since 25.07.2025
 * @author Nikita Kirillov
 */
public interface BasicJwtVerificationStrategy {
     ...
     */
    void verifyAndParse(String token, String signingKey) throws JwtException, IllegalArgumentException;
}
